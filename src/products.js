...
export const products = [
  ...
  {
    id: 34,
    name: "Purosis Plus RO (White)",
    category: "purifier",
    price: 11999,
    warranty: "1 Year",
    efficiency: "RO | Household",
    image: "/images/purosiswhite.png",
    description:
      "Purosis Plus variant with upgraded design and reliable multi-stage RO filtration. White body for modern kitchens.",
    features: [
      "Multi-stage RO purification",
      "Sediment + carbon pre-filtration",
      "Taste enhancer (post-carbon)",
      "Wall-mount ready",
      "Serviceable filters",
    ],
    specs: {
      brand: "Purosis",
      model: "Purosis Plus (White)",
      purificationType: "RO (Reverse Osmosis)",
      stages: "4–5 stages (sediment, carbon, RO, post-carbon/taste enhancer)",
      storageCapacity: "8 Litres",
      flowRate: "10–12 LPH",
      tdsRange: "Up to 2000 ppm input",
      filterLife: "12–18 months (depends on TDS)",
      warranty: "1 Year (Purosis service)",
      installation: "Wall-mounted",
      ideal: "Families needing reliable RO with a premium look",
      annualServiceCost: "₹2,000–3,500",
    },
    faqs: [
      { q: "Is this different from Purosis RO?", a: "Yes. Plus variant typically comes with updated body/design and similar RO performance depending on configuration." },
      { q: "What water TDS is it suitable for?", a: "Works well up to ~2000 ppm input; for very high TDS, ensure membrane quality and timely service." },
      { q: "How often to change filters?", a: "Usually every 12–18 months (earlier if input water is hard/high TDS)." },
    ],
  },
  ...
  {
    id: 35,
    name: "Purosis Plus RO (Black)",
    category: "purifier",
    price: 12999,
    warranty: "1 Year",
    efficiency: "RO | Household",
    image: "/images/purosisplus.png",
    description:
      "Purosis Plus RO in black finish with dependable daily purification and a premium look for modular kitchens.",
    features: [
      "Multi-stage RO purification",
      "Sediment + carbon pre-filtration",
      "Taste enhancer (post-carbon)",
    ...
    specs: {
      ...
      warranty: "1 Year (Purosis service)",
      installation: "Wall-mounted",
      ideal: "Premium kitchens, users who prefer black finish",
      annualServiceCost: "₹2,000–3,500",
    },
    faqs: [
      { q: "Is black only color difference?", a: "Functionally similar; exact internals depend on the variant you stock (UV/UF/mineral can be added if required)." },
      { q: "Does it need electricity?", a: "Yes, RO uses a pump and needs power." },
      { q: "Can it be serviced locally?", a: "Yes, filters and membrane are serviceable; schedule periodic maintenance for best output." },
    ],
  },
  ...
  {
    id: 36,
    name: "On-Grid Rooftop Solar 2 kW",
    category: "rooftop-solar",
    price: 135000,
    originalPrice: 150000,
    warranty: "25 Years Panel Performance | 5 Years Installation",
    efficiency: "2 kW | On-Grid",
    image: "/images/IND-Rooftop-Solar-1.jpg",
    description:
      "Popular residential rooftop solar system for medium-sized homes. Handles fans, lights, TV, refrigerator, and daily household loads efficiently.",
    features: [
      ...
      "Long lifespan",
      "Subsidy eligible (where applicable)",
    ],
    specs: {
      brand: "Supreme Solar",
      systemType: "On-Grid Rooftop Solar",
      capacity: "2 kW",
      dailyGeneration: "8–10 Units/day",
      monthlyGeneration: "240–300 Units/month",
      panelType: "Mono PERC Half-Cut",
      inverterType: "Grid-Tie Inverter",
      installationArea: "~200 sq.ft",
      suitableFor: "2 BHK homes",
      netMetering: "Supported",
      idealFor: "Medium electricity consumers",
      paybackPeriod: "3–5 Years",
    },
    faqs: [
      {
        q: "Can I run an AC?",
        a: "Yes, one 1-ton inverter AC during daytime usage is possible.",
      },
      {
        q: "Is subsidy available?",
        a: "Yes, depending on state and central government schemes.",
      },
    ],
  },
  ...
  {
    id: 37,
    name: "On-Grid Rooftop Solar 5 kW",
    category: "rooftop-solar",
    price: 315000,
    originalPrice: 350000,
    warranty: "25 Years Panel Performance | 5 Years Installation",
    efficiency: "5 kW | On-Grid",
    image: "/images/solar roof 3.jpg",
    description:
      "Premium rooftop solar solution for villas, duplex homes, offices, and commercial establishments with high electricity bills.",
    features: [
    ...
    specs: {
      ...
      installationArea: "~500 sq.ft",
      suitableFor: "Large homes / Villas / Offices",
      inverterType: "Commercial Grid-Tie Inverter",
      panelType: "Mono PERC Half-Cut",
      netMetering: "Supported",
      idealFor: "High EB bill reduction",
      paybackPeriod: "3–5 Years",
    },
    faqs: [
      {
        q: "Can this reduce my electricity bill to near zero?",
        a: "For many homes and offices, yes — especially with daytime consumption and net metering.",
      },
      {
        q: "Can batteries be added later?",
        a: "Yes, hybrid upgrades are possible in future.",
      },
    ],
  },
  ...
  {
    id: 38,
    name: "Hybrid Rooftop Solar 5 kW with Battery Backup",
    category: "rooftop-solar",
    price: 495000,
    originalPrice: 550000,
    warranty: "25 Years Panel Performance | 5 Years Installation",
    efficiency: "5 kW | Hybrid",
    image: "/images/hybrid rooftop.webp",
    description:
      "Hybrid rooftop solar system with battery backup for uninterrupted power during outages while still reducing electricity bills.",
    features: [
      ...
      "Premium safety protections",
    ],
    specs: {
      brand: "Supreme Solar",
      systemType: "Hybrid Solar System",
      capacity: "5 kW",
      batteryBackup: "5–10 kWh (customizable)",
      dailyGeneration: "20–25 Units/day",
      installationArea: "~550 sq.ft",
      inverterType: "Hybrid Inverter",
      panelType: "Mono PERC",
      suitableFor: "Homes needing backup + savings",
      idealFor: "Areas with frequent power cuts",
      backupSupport: "Fans, lights, fridge, WiFi, TVs, selected AC loads",
    },
    faqs: [
      {
        q: "What is the difference between on-grid and hybrid?",
        a: "Hybrid systems include battery backup and continue supplying power during outages.",
      },
      {
        q: "Is battery replacement expensive?",
        a: "Lithium batteries last 8–12 years and require very low maintenance.",
      },
    ],
  },
  ...
  {
    id: 39,
    name: "Heat Pump Water Heater 100 LPH",
    category: "heat-pump",
    price: 90000,
    originalPrice: 98000,
    warranty: "2 Years",
    efficiency: "COP up to 3.4 | 100 LPH",
    image: "/images/heatpump.jpg",
    description:
      "Compact commercial heat pump delivering high energy savings with reliable all-weather performance.",
    features: [
      "COP up to 3.4",
    ...
    specs: {
      ...
      capacity: "100 LPH",
      cop: "Up to 3.4",
      powerConsumption: "Energy-saving operation",
      operatingTemperature: "2°C to 43°C",
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Small homes, villas, cafes, salons",
    },
  },

  {
    id: 40,
    name: "Heat Pump Water Heater 150 LPH",
    category: "heat-pump",
    price: 110000,
    originalPrice: 118000,
    warranty: "2 Years",
    efficiency: "COP up to 3.4 | 150 LPH",
    image: "/images/heatpump.jpg",
    description:
      "Mid-capacity heat pump suitable for homes and small commercial establishments with reduced electricity costs.",
    features: [
      "COP up to 3.4",
    ...
    specs: {
      ...
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Homes, hostels, restaurants",
    },
  },

  {
    id: 41,
    name: "Heat Pump Water Heater 200 LPH",
    category: "heat-pump",
    price: 138000,
    originalPrice: 145000,
    warranty: "2 Years",
    efficiency: "COP up to 3.4 | 200 LPH",
    image: "/images/heatpump500ltr.jpg",
    description:
      "High-efficiency heat pump delivering reliable hot water with major electricity savings.",
    features: [
      "COP up to 3.4",
    ...
    specs: {
      ...
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Large homes, hotels, apartments",
    },
  },

  {
    id: 42,
    name: "Heat Pump Water Heater 300 LPH",
    category: "heat-pump",
    price: 160000,
    originalPrice: 172000,
    warranty: "2 Years",
    efficiency: "COP up to 3.5 | 300 LPH",
    image: "/images/heatpump.jpg",
    description:
      "Commercial-grade heat pump designed for continuous hot water demand with maximum efficiency.",
    features: [
      "High COP efficiency",
      "Commercial-duty compressor",
    ...
    specs: {
      ...
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Hotels, hospitals, hostels",
    },
  },

  {
    id: 43,
    name: "Heat Pump Water Heater 500 LPH",
    category: "heat-pump",
    price: 220000,
    originalPrice: 235000,
    warranty: "2 Years",
    efficiency: "COP up to 3.5 | 500 LPH",
    image: "/images/heatpump.jpg",
    description:
      "Heavy-duty industrial heat pump suitable for large-scale hot water applications.",
    features: [
      "Industrial-grade performance",
      "Massive electricity savings",
      "Continuous heating support",
    ...
    specs: {
      ...
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Industries, resorts, hospitals, apartments",
    },
  },

  {
    id: 44,
    name: "Heat Pump Water Heater 1000 LPH",
    category: "heat-pump",
    price: 415000,
    originalPrice: 435000,
    warranty: "2 Years",
    efficiency: "COP up to 3.6 | 1000 LPH",
    image: "/images/heatpump.jpg",
    description:
      "Ultra high-capacity industrial heat pump built for large commercial and institutional usage.",
    features: [
      "Maximum energy efficiency",
      "Industrial continuous operation",
      "Advanced digital controls",
      "High-capacity hot water production",
    ...
    specs: {
      ...
      refrigerant: "R32",
      warranty: "2 Years Compressor, 5 Years Tank",
      ideal: "Large hotels, factories, institutions, hospitals",
    },
  },
