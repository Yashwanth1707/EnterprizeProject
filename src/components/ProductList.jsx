...
export const products = [
  ...
  { id: 3, name: "Heavy Plus 200 LPD", category: "solar", price: 24500, warranty: "5 Years", efficiency: "ETC | 200 LPD", image: "/images/hp110.jpeg", description: "Popular family-size ETC with reliable hot water across most seasons at low cost.", features: ["Heavy Plus build", "Fast heating", "Weather resistant", "Low maintenance"] },
  ...
  { id: 5, name: "Heavy Plus 270 LPD", category: "solar", price: 31000, warranty: "5 Years", efficiency: "ETC | 270 LPD", image: "/images/hp220.webp", description: "Higher capacity system for duplexes or two bathrooms running in parallel.", features: ["Heavy Plus build", "Fast heating", "Weather resistant", "Low maintenance"] },
